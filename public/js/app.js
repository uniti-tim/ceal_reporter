...
$(function () {
  if (window.page === 'home') {
    var $quotesPie = $('#quotes_pie');
    var $quotesPieLoader = $('#quotes_pie_loader');
    var $quotesVolume = $('#quotes_volume');
    var $quotesVolumeLoader = $('#quotes_volume_loader');
    var $quotesMRC = $('#quotes_mrc');
    var $quotesMRCLoader = $('#quotes_mrc_loader');
